...
export default class BlendedCube extends GenericCanvasExperimentView {
    static defaultProps = {
        aliasName: 'blended-cube',
        canvasId: 'blended-cube-canvas',
        fileName: 'BlendedCube.jsx'
    };
    ...
    componentDidMount () {
        ...
        function initBufferWithData (bufferType, numParts, attribType, attribName, bufferData, stride = 0) {
            const buffer = gl.createBuffer(),
                a_Attrib = attribLoc(gl, attribName);
            gl.bindBuffer(bufferType, buffer);
            gl.bufferData(bufferType, bufferData, gl.STATIC_DRAW);
            gl.vertexAttribPointer(a_Attrib, numParts, attribType || gl.FLOAT, false, stride, 0);
