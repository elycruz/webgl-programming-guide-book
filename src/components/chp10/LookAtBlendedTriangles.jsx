...
export default class LookAtBlendedTriangles extends GenericCanvasExperimentView {
    static defaultProps = {
        aliasName: 'look-at-blended-triangles',
        canvasId: 'look-at-blended-triangles-canvas',
        fileName: 'LookAtBlendedTriangles.jsx'
    };
    componentDidMount () {
                ...
                const verticeAndSizes = new Float32Array([
                        // X, Y, Z, R, G, B
                         ...
                         -0.5, -0.5, -0.4,  0.4,  1.0,  0.4,  0.4,
                          ...
                          0.5,  0.5, -0.2,  1.0,  0.4,  0.4,  0.4, // The middle, yellow triangle
                         -0.5,  0.5, -0.2,  1.0,  1.0,  0.4,  0.4,
                          0.0, -0.5, -0.2,  1.0,  1.0,  0.4,  0.4,
