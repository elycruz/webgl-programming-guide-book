    ...
    componentDidMount () {
        ...
        function initVertexBuffers (glContext) {
            const verticeAndSizes = new Float32Array([
                    ...
                    // Triangles in the center
                     0.0,  2.5, -5.0, 0.0, 1.0, 0.0,  // Blue triangle in front
                    -2.5, -2.5, -5.0, 0.0, 1.0, 0.0,
                     2.5, -2.5, -5.0, 1.0, 0.0, 0.0,

                     0.0,  3.0, -5.0, 1.0, 0.0, 0.0,  // Blue triangle in front
            ...
            return !vertexBuffer ? -1 : verticeAndSizes.length / 6; // num sides in shape
        }
        ...
        if (numCreatedVertices === -1) {
            error('Error while creating vertices buffer.');
                                ...
                                //  x   y   z
        const eye = vec3.fromValues(0,  0,  13),  // Get converted to floating point
